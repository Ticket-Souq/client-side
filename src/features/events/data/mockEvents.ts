...
export const MOCK_CARDS: EventCardResponse[] = [
  { id: 'evt-1', title: 'Nile Nights Festival', posterUrl: '', status: 'PUBLISHED', startDate: '2026-07-25T19:00:00', category: 'Music', venueName: 'Cairo Festival Grounds', priceFrom: 450, currency: 'EGP', ticketsAvailable: 1200, ticketsSold: 850 },
  { id: 'evt-2', title: 'Rooftop Jazz Evening', posterUrl: '', status: 'PUBLISHED', startDate: '2026-07-22T20:00:00', category: 'Music', venueName: 'Zamalek Sky Lounge', priceFrom: 350, currency: 'EGP', ticketsAvailable: 200, ticketsSold: 150 },
  { id: 'evt-3', title: 'Comedy Night Cairo', posterUrl: '', status: 'PUBLISHED', startDate: '2026-07-18T21:00:00', category: 'Theatre', venueName: 'Downtown Comedy Club', priceFrom: 250, currency: 'EGP', ticketsAvailable: 300, ticketsSold: 290 },
  { id: 'evt-4', title: 'Art Expo 2026', posterUrl: '', status: 'PUBLISHED', startDate: '2026-07-30T10:00:00', category: 'Conference', venueName: 'Cairo Opera House', priceFrom: 200, currency: 'EGP', ticketsAvailable: 500, ticketsSold: 180 },
  { id: 'evt-5', title: 'Cairo Food Festival', posterUrl: '', status: 'PUBLISHED', startDate: '2026-08-14T12:00:00', category: 'Food', venueName: 'New Cairo Exhibition Park', priceFrom: 120, currency: 'EGP', ticketsAvailable: 2000, ticketsSold: 600 },
  { id: 'evt-6', title: 'Marathon 2026', posterUrl: '', status: 'PUBLISHED', startDate: '2026-09-09T06:00:00', category: 'Sports', venueName: 'Sheikh Zayed Track', priceFrom: 300, currency: 'EGP', ticketsAvailable: 5000, ticketsSold: 3200 },
  { id: 'evt-7', title: 'Electronic Music Summit', posterUrl: '', status: 'PENDING', startDate: '2026-08-20T22:00:00', category: 'Music', venueName: 'The Roof, New Cairo', priceFrom: 600, currency: 'EGP', ticketsAvailable: 800, ticketsSold: 0 },
  { id: 'evt-8', title: 'Hamlet – Modern Revival', posterUrl: '', status: 'DRAFT', startDate: '2026-09-10T19:30:00', category: 'Theatre', venueName: 'Downtown Arts Centre', priceFrom: 800, currency: 'EGP', ticketsAvailable: 150, ticketsSold: 0 },
  { id: 'evt-9', title: 'Tech Talks 2026', posterUrl: '', status: 'CANCELLED', startDate: '2026-10-05T09:00:00', category: 'Conference', venueName: 'Convention Hall A', priceFrom: 500, currency: 'EGP', ticketsAvailable: 0, ticketsSold: 120 },
  { id: 'evt-10', title: 'Sufi Night Under the Stars', posterUrl: '', status: 'PUBLISHED', startDate: '2026-08-01T20:00:00', category: 'Music', venueName: 'Citadel Amphitheatre', priceFrom: 400, currency: 'EGP', ticketsAvailable: 600, ticketsSold: 420 },
]
