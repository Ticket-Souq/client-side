...
export const CUSTOMER_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'c-8', title: 'Welcome', preview: `Welcome to ${BRAND_NAME}! Start exploring events.`, timeAgo: '2 weeks ago', timestamp: '2026-07-09T08:00:00Z', read: true },
]
...
export const ADMIN_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'a-8', title: 'Welcome', preview: `Welcome to the ${BRAND_NAME} admin panel.`, timeAgo: '2 weeks ago', timestamp: '2026-07-09T08:00:00Z', read: true },
]
...
export const ORGANIZER_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'o-8', title: 'Welcome', preview: `Welcome to ${BRAND_NAME}! Start creating events.`, timeAgo: '1 month ago', timestamp: '2026-06-23T08:00:00Z', read: true },
]
